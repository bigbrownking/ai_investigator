...
public enum NotFoundMessage implements LocalizedMessage {
    ...
    FIGURANT("Фигурант не найден", "Фигурант табылмады"),
    TIMER_SESSSION("Нет активной сессии таймера для паузы", "Белсенді таймер сеансы жоқ — үзілісті бастау мүмкін емес"),
